...
class Form:
    def __init__(self, root):
        ...
        # self.title_label = tk.Label(self.header_frame, text="Welcome to the Car Parking System",font=("Helvetica", 24), fg="white", bg='blue')
        ...
        self.frame.place(x=500, y=250, width=480, height=450)

        title_label = tk.Label(self.frame, text="Welcome to the Car Parking System",font=("Helvetica", 20), fg="white", bg='blue')
        title_label.pack(pady=20)

        title_label = tk.Label(self.frame, text="Create an Account", font=("Helvetica", 30), fg="white", bg="black")
        title_label.pack(pady=5)

        self.user_name_label = tk.Label(self.frame, text="User Name:", font=("times new roman", 18, "bold"), fg="white", bg="black")
        self.user_name_label.place(x=50, y=150)
        self.user_name_entry = tk.Entry(self.frame, font=('arial', 16))
        self.user_name_entry.place(x=200, y=150)
